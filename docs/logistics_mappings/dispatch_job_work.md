# Dispatch Process (Job Work) Mapping
...
4. For JOB WORK DC, Navigate to the Inventory module in the Odoo dashboard.
5. Click on JOB WORK and select New to initiate the delivery creation.
...
1. Sales creates SO for job work.
2. Verify details.
3. Transfer material to FG stock for LOT.
4. Create Delivery Note for job work.
...
## ERPNext Solutions
- Work Order integration for job work tracking.
- Automated transfers and validations.
